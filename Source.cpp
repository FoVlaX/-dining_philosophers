...
class waiter { //"официант"с семафором регулирующий подачу вилок
public:
	waiter(int s) {
...
class fork : public waiter { //вилка c семафором, чтобы два философа не смогли взять одновременно одну и ту же вилку и войти вместе в критический участок
public:
